...
var uselessWords = map[string]struct{}{
	...
	"would": {}, "you": {}, "you'd": {}, "you'll": {}, "you're": {}, "you've": {}, "your": {}, "yours": {},
	"yourself": {}, "yourselves": {},
}
...
func removeUselessWords(text string) string {
	...
	for i, word := range words {
		...
		if _, ok := uselessWords[strings.ToLower(word)]; !ok {
